...
public class GetHistoryMessageProcessorDebuggable
    extends GetHistoryMessageProcessor
    implements DebugInfoProvider
{


    public GetHistoryMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("symbols", "Symbols", (java.lang.String.class), symbols, muleEvent));
