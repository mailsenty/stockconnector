...
/**
 * A <code>StockConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link StockConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-18T02:17:01-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class StockConnectorLifecycleInjectionAdapter
    extends StockConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(StockConnectorLifecycleInjectionAdapter.class);
